        ...
        <Layout>
                ...
                <div className="wrap pb-10 md:py-10 grid grid-cols-12 grid-rows-4 md:grid-rows-7 gap-4 h-[150vh] md:h-auto">
                    ...
                    <div data-aos="fade-right" className="col-start-4 col-span-9 row-start-1 row-span-1 md:col-start-2 md:col-span-2 md:row-span-7 rounded-3xl overflow-hidden bg-[#FF0201] relative">
                        <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 -rotate-90 flex flex-col leading-none text-white'>
                            <div className='text-[13rem] font-bold'>2009</div>
                            <div className='text-3xl text-center'>Gründung der GmbH</div>
                        </div>
                    </div>
                    <div data-aos="fade-down" className="col-start-2 col-span-9 row-start-2 row-span-1 md:col-span-8 md:row-span-5 bg-black text-white rounded-3xl p-8 xl:p-16 flex flex-col justify-between shadow-md overflow-hidden">
                        <div className='text-4xl text-zinc-700'>Leistungsentwicklung im Überblick</div>
                        <div class="grafik grid grid-flow-col items-end gap-4 absolute bottom-0 left-0 w-full h-3/6 aos-init aos-animate" data-aos="fade-up" data-aos-duration="500">
                            {performance.map((item, index) => {
                                return (
                                    ...
                                    >
                                        <div className="text-center text-white text-sm mt-4">{item.kWp} kWp</div>
                                        <div className="text-center text-zinc-700 text-base mb-4">{item.year}</div>
                                    </div>
                                )
                            })}
                        </div>
                    ...
                    <div data-aos="fade-up" className="col-start-1 col-span-12 ml-4 md:ml-0 row-start-4 row-span-1 md:col-start-4 md:col-span-3 md:row-span-2 xl:text-xl bg-black text-white rounded-3xl p-4 md:p-10">
                        <h3 className="text-8xl mb-2">2012</h3>
                        <p className="font-light">Umwandlung in Stromunion AG</p>
                    </div>
                    <div data-aos="fade-up" className="col-start-1 col-span-12 ml-4 md:ml-0 row-start-4 row-span-1 md:col-start-7 md:col-span-5 md:row-span-2 xl:text-xl bg-black text-white rounded-3xl p-4 md:p-10 font-light">
            ...
            <section id="step-by-step" className="py-10 bg-black">
                <div className="container py-20 text-zinc-200" data-aos="fade-up">
                    <h3 className='text-6xl font-light line'>Unsere Vision</h3>
                ...
                <div className="container md:max-w-[40%] py-10 text-zinc-200 text-center" data-aos="fade-up">
                    <h3 className='text-4xl font-light line inline-block mx-auto'>Haben wir Ihr Interesse geweckt?</h3>
                    ...
                    <div className='mt-10'>
                        <Link to="/leistungen" id="call-to-action" className="border-[#FF0201] bg-black border-4 transition duration-800 ease-in-out hover:bg-[#FF0201] text-2xl text-zinc-200 py-4 px-8 rounded-full align-middle">
                            Jetzt entdecken <FontAwesomeIcon icon={faCircleArrowRight} size="2x" className="w-8 h-8 ml-5 text-zinc-200 relative" />
                        </Link>
                    </div>
                </div>
            </section>
